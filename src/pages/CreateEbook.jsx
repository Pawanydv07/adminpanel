...
function CreateEbook() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-6 bg-white shadow-md rounded-lg">
      ...
      {/* Title Section */}
      <h2 className="text-blue-600 text-xs font-bold">EBOOKS / CREATE EBOOK</h2>
      <h1 className="text-2xl font-bold mb-4">Create Ebook</h1>
      <p className="text-gray-500 mb-6">Start creating a new ebook</p>
